...
slaveInfo[1]  = [2, 4, 6, 8, 9];
slaveInfo[2]  = [2, 4, 6, 8, 9];
slaveInfo[3]  = [2, 4, 6, 8, 9];
slaveInfo[4]  = [2, 4, 6, 8, 9];
slaveInfo[5]  = [2, 4, 6, 8, 9];
slaveInfo[6]  = [2, 4, 5, 6, 7, 8, 9];
slaveInfo[7]  = [2, 4, 5, 6, 7, 8, 9];
slaveInfo[8]  = [1, 9];
slaveInfo[9]  = [2, 8, 9];
slaveInfo[10] = [1, 4, 5, 6, 9];
slaveInfo[11] = [2, 4, 5, 6, 8, 9];
slaveInfo[12] = [2, 6, 9];
slaveInfo[13] = [2, 6, 9];
slaveInfo[14] = [2, 8, 9];
slaveInfo[15] = [2, 6, 9];
slaveInfo[16] = [2, 9];
slaveInfo[17] = [2, 4, 6, 7, 8];
slaveInfo[18] = [2, 4, 5, 6, 8];
slaveInfo[19] = [2, 4, 5, 6, 7, 8, 9];
slaveInfo[20] = [1, 2, 3, 6, 9]; //起始圖
slaveInfo[21] = [4, 8, 9];
slaveInfo[22] = [3, 6, 7, 8];
